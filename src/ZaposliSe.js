  ...
  return (
    <div className="zaposlisediv">
      <div className="prvidivzaposlise">
        <div className="levozaposlise">
          ...
          <p className="textzaposlise">
            Prijavite se za posao brzo, lako i jednostavno. Sve što je potrebno
            da uradite je da popunite formu koja se nalazi na stranici niže, i
            to je sve.
          </p>
        </div>
      ...
      <div className="prijaviseforma">
        <p className="naslovprijavise">Prijava za posao</p>

        <form className="formazaposlise" ref={form} onSubmit={handlePosao}>
          <label className="svelabele">Ime</label>
          <input
            type="text"
            required="required"
            className="sviinputi"
          ...
          <label className="svelabele">Prezime</label>
          <input
            type="text"
            required="required"
            className="sviinputi"
          ...
          <label className="svelabele">Telefon</label>
          <input
            type="text"
            required="required"
            className="sviinputi"
          ...
          <label className="svelabele">Email</label>
          <input
            type="mail"
            required="required"
            className="sviinputi"
          ...
          <label className="svelabele">Radno iskustvo</label>
          <textarea
            className="textareainputi"
            required="required"
            name="iskustvo"
            value={iskustvo}
          ...
          <label className="svelabele">Vasa poruka</label>
          <textarea
            className="textareainputi"
            required="required"
            name="poruka"
          ...
          <button className="zaposliseButton" value="Send" type="submit">
            Prijavi se
          </button>
        </form>
      </div>
